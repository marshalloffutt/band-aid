...
GO
/****** Object:  Table [dbo].[BandShindig]    Script Date: 7/16/2019 7:02:31 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[BandShindig](
	[Id] [int] IDENTITY(1,1) NOT NULL,
	[BandId] [int] NOT NULL,
	[ShindigId] [int] NOT NULL,
 CONSTRAINT [PK_BandEvent] PRIMARY KEY CLUSTERED 
(
	[Id] ASC
)WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON) ON [PRIMARY]
) ON [PRIMARY]
...
GO
ALTER TABLE [dbo].[BandShindig]  WITH CHECK ADD  CONSTRAINT [FK_BandEvent_Band] FOREIGN KEY([BandId])
REFERENCES [dbo].[Band] ([Id])
GO
ALTER TABLE [dbo].[BandShindig] CHECK CONSTRAINT [FK_BandEvent_Band]
GO
ALTER TABLE [dbo].[BandShindig]  WITH CHECK ADD  CONSTRAINT [FK_BandEvent_Event] FOREIGN KEY([ShindigId])
REFERENCES [dbo].[Shindig] ([Id])
GO
ALTER TABLE [dbo].[BandShindig] CHECK CONSTRAINT [FK_BandEvent_Event]
GO
...
VALUES ('Rehearsal', '2019-07-16', '6653 Germantown Blvd','Nashville', 'Tennessee', 37433, 0)

INSERT INTO [dbo].[Shindig] ([Description], [EventDate], [Address], [City], [State], [Zipcode], [HasComeToPass]) 
VALUES ('Practice', '2019-07-16', '1123 Blakemore Dr', 'Houston', 'Texas', 34778, 0)
...
-- Band-Shindigs Seed Data
INSERT INTO [dbo].[BandShindig] ([BandId], [ShindigId]) VALUES (4, 1)
INSERT INTO [dbo].[BandShindig] ([BandId], [ShindigId]) VALUES (2, 2)
